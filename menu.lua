...
repeat
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'LunarX.<font color="rgb(115, 100, 215)">Paid</font> - uid: <font color="rgb(115, 100, 215)">' .. uid .. '</font> / fps: <font color="rgb(115, 100, 215)">' .. fpsValue .. '</font> / ping: <font color="rgb(115, 100, 215)">' .. ping .. '</font> / time: <font color="rgb(115, 100, 215)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'LunarX.<font color="rgb(115, 100, 215)">Paid</font> || fallen',
    ...
    BuildLabel.Text = "build: <font color=\"rgb(115, 100, 215)\">PAID</font>"
        ...
        function library:Notify(Text, Time)
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("LunarX/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("LunarX") do table.insert(tbl,v) end
